...
<<<<<<< HEAD
						...
						Hora: <span style="font-weight:bold"><?php echo urldecode($row["c9"]); ?></span><br>
						Estado: <span style="font-weight:bold">
								<?php switch(urldecode($row["c7"]))
									  {
										case "0": echo "Denegada"; break;
